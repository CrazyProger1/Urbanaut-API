...
from src.apps.abandoned.models.objects import AbandonedObject, AbandonedObjectFile
...
from src.apps.abandoned.models.categories import AbandonedObjectCategory
