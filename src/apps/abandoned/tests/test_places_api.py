...
class PlaceAPIFiltersTestCase(APITestCase):
    ...
    def test_filter_by_name(self):
        place_alpha = Place.objects.create(
            name="Alpha", point=Point(30.0, 50.0), created_by=self.user
        )
        place_beta = Place.objects.create(
            name="Beta", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_area(self):
        ...
        place_in_area = Place.objects.create(
            name="In Area", point=Point(30.0, 50.0), created_by=self.user, area=area
        )
        place_no_area = Place.objects.create(
            name="No Area", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_tags(self):
        ...
        place_tagged = Place.objects.create(
            name="Tagged", point=Point(30.0, 50.0), created_by=self.user
        )
        place_tagged.tags.add(tag)
        place_untagged = Place.objects.create(
            name="Untagged", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_query(self):
        place_match = Place.objects.create(
            name="Abandoned Factory", point=Point(30.0, 50.0), created_by=self.user
        )
        place_no_match = Place.objects.create(
            name="Xyzzy Nothing", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_ai_query(self):
        place_match = Place.objects.create(
            name="Ghostly Hospital", point=Point(30.0, 50.0), created_by=self.user
        )
        place_no_match = Place.objects.create(
            name="Other Place", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_preservation(self):
        place_high = Place.objects.create(
            name="Well Preserved", point=Point(30.0, 50.0), created_by=self.user
        )
        ...
        place_none = Place.objects.create(
            name="Ruins", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_security(self):
        place_secured = Place.objects.create(
            name="Secured Place", point=Point(30.0, 50.0), created_by=self.user
        )
        ...
        place_open = Place.objects.create(
            name="Open Place", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_has_security(self):
        place_guarded = Place.objects.create(
            name="Guarded", point=Point(30.0, 50.0), created_by=self.user
        )
        ...
        place_open = Place.objects.create(
            name="Open", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_country(self):
        ...
        place_ua = Place.objects.create(
            name="Ukrainian Place",
            point=Point(30.0, 50.0),
            created_by=self.user,
            address=address,
        )
        place_no_country = Place.objects.create(
            name="No Country", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_is_favorite(self):
        place_fav = Place.objects.create(
            name="Favorite", point=Point(30.0, 50.0), created_by=self.user
        )
        UserFavoritePlace.objects.create(user=self.user, place=place_fav)
        place_not_fav = Place.objects.create(
            name="Not Favorite", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_is_private(self):
        place_private = Place.objects.create(
            name="Private",
            point=Point(30.0, 50.0),
            created_by=self.user,
            is_private=True,
        )
        place_public = Place.objects.create(
            name="Public", point=Point(11.0, 21.0), created_by=self.user
        )
    ...
    def test_filter_by_is_supposed(self):
        place_supposed = Place.objects.create(
            name="Supposed",
            point=Point(30.0, 50.0),
            created_by=self.user,
            is_supposed=True,
        )
        place_regular = Place.objects.create(
            name="Regular", point=Point(11.0, 21.0), created_by=self.user
        )
