...
def calculate_signature(pk: str, balance_in_pk: str, balance_out_pk: str, amount: int, timestamp: float,
...
def verify(signature: str, pk: str, balance_in_pk: str, balance_out_pk: str, amount: int, timestamp: float,
           previous_signature: str) -> bool:
    try:
